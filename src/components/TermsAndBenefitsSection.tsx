...
export const TermsAndBenefitsSection: React.FC = () => {
  ...
  return (
    <section id="terms" className="py-20 sm:py-28 bg-[#0D0E12] border-b border-gold-500/20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Directory Navigation in Black & Gold */}
        <div className="space-y-8">
            ...
            {navigationItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`px-5 py-3 text-xs font-bold uppercase tracking-wider whitespace-nowrap transition-all border-b-2 -mb-px ${
                    isActive
          ...
          <div className="dark-glass-card p-8 sm:p-12 min-h-[420px] border-gold-500/30">
              ...
              <div className="space-y-6">
                ...
                <div className="overflow-x-auto border border-stone-800">
                  <table className="w-full text-left text-xs sm:text-sm border-collapse">
                    <thead>
                      <tr className="bg-[#0A0A0E] border-b border-stone-800 text-gold-300 font-serif font-semibold">
                ...
                <div className="p-4 bg-[#0A0A0E] border border-gold-500/20 text-xs text-gold-400 font-serif italic">
            ...
            {activeSection === 'payments' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="p-6 bg-[#0A0A0E] border border-gold-500/20 space-y-2">
            ...
            {activeSection === 'claims' && (
              <div className="space-y-6">
                ...
                <div className="bg-[#0A0A0E] border border-gold-500/20 p-6 space-y-3">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 divide-y md:divide-y-0 md:divide-x divide-stone-800">
                  ...
                  <div className="space-y-4 md:pl-8 pt-6 md:pt-0">
                    <h4 className="font-serif text-xl font-medium text-gold-300">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-4 bg-[#0A0A0E] border border-gold-500/20 text-xs text-stone-300 space-y-1">
