...
import { SUPPORT_PACKAGES, TERMS_CONTENT } from '../data/pfpData';
            ...
            >
              ...
              <div className="space-y-5 pt-6 border-t border-[#1E2028]">
                <div className="p-4 rounded bg-[#0A0B0E] border border-[#1E2028] space-y-2">
                  <div className="flex justify-between items-baseline">
                    <span className="text-xs text-stone-400 uppercase tracking-wider">
                      Monthly Premium ({selectedAgeBand} yrs)
                    </span>
                  </div>
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded bg-gold-400 hover:bg-gold-300 text-[#0B0C0E] text-xs font-semibold uppercase tracking-wider transition-colors shadow-sm"
                >
                  Request {pkg.name} Schedule
                </button>
              </div>
            </div>
          );
